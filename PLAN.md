...
- Next recommended implementation unit after the Phase 7.1 commit/push: Phase 7.2, structured outcome classification using `@Generable RunSummary` so accuracy/dashboard signals get stamped automatically.
