...
- Visual regression coverage expansion: build out additional sprint-O matrices for the Conflict Center recovery flow, run-sheet continuation depth, and Foundation Models diagnostics surface so they share the same baselines as the existing matrices.
